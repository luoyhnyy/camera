...
# try:
#     ImageConvertdll = windll.LoadLibrary(os.path.abspath('.')+r"\ImageConvert.dll")
# except:
#     pass
# ImageConvertdll = OleDLL(os.path.abspath('.')+r"\ImageConvert.dll")
os.environ['path'] += ';%s'%(os.path.abspath('.'))   #添加dll依赖库目录到系统环境
# ImageConvertdll = cdll.LoadLibrary('ImageConvert.dll')
if struct.calcsize("P") != 4:
    ImageConvertdll = OleDLL(r"./ImageConvert.dll")
else:
    ImageConvertdll = OleDLL(r"./ImageConvert32.dll")
